...
export const SEGMENTS: Record<SegmentCode, SegmentMeta> = {
  H1: {
    ...
    description: "Pembayar tepat waktu, tidak ada tunggakan",
  ...
  K1: {
    ...
    description: "Tunggakan 1-90 hari — konversi tertinggi (60%)",
    treatment: "Reminder WhatsApp / SMS",
  },
  O1: {
    code: "O1",
    name: "Mulai Mengabaikan",
    nameLong: "Mulai Mengabaikan (O1)",
    description: "Tunggakan 91-365 hari — konversi 35%",
    treatment: "Reminder + insentif diskon denda",
  },
  M1: {
    code: "M1",
    name: "Tidak Patuh Pasif",
    nameLong: "Tidak Patuh Pasif (M1)",
    description: "Tunggakan 1-2 tahun — konversi 25%",
    treatment: "Amnesti parsial 50-75% denda",
  },
  M2: {
    code: "M2",
    name: "Tidak Patuh Kronis",
    nameLong: "Tidak Patuh Kronis (M2)",
    description: "Tunggakan 2-5 tahun — konversi 15%, beban historis terbesar",
  ...
  S1: {
    ...
    description: "Kendaraan <15 tahun belum daftar — bukan masalah collection",
  ...
  S2: {
    ...
    description: "Kendaraan tua/lama tidak teridentifikasi — kandidat deregistrasi",
    treatment: "Cleanup / deregistrasi",
  },
};
