...
const dataEngineering = [
  ...
  new Paragraph({ text: '', spacing: { after: 240 } }),
  createHeading('4.2 Migrations', 2),
  new Paragraph({
    text: '25 migrations applied from February 6–8, 2026. Covers: star schema setup, agent system tables, gold views, data backfills, and RPC function definitions.',
    spacing: { after: 240 }
  }),
  createHeading('4.3 Edge Functions (3)', 2),
  ...
  new Paragraph({ text: '', spacing: { after: 240 } }),
  createHeading('4.4 Security Issues (CRITICAL)', 2),
  new Paragraph({
  ...
  new Paragraph({ text: '', spacing: { after: 240 } }),
  createHeading('4.5 Data Integrity', 2),
